export const blueLineCoordinates = [
  ...
  { lat: 24.65937806638777, lng: 46.70500072886349 },
  { lat: 24.666755399586886, lng: 46.70160476836777 },
  ...
  { lat: 24.761003, lng: 46.651219 },
  { lat: 24.761829, lng: 46.650602 },
  { lat: 24.762348, lng: 46.649765 },

  { lat: 24.763446, lng: 46.646088 },
  { lat: 24.763894, lng: 46.645557 },
  { lat: 24.765901, lng: 46.644544 },



  { lat: 24.766447, lng: 46.643667 },
  {
    lat: 24.7673492,
    lng: 46.6430042,
...
export const blueStations = [
  //1j2
  { lat: 24.559764845169465, lng: 46.77643482931522 },
  //1j1
  { lat: 24.58742767985831, lng: 46.7607820315081 },
  //1h2
  { lat: 24.598442258971417, lng: 46.745230136074085 },
  //1g2
  { lat: 24.60084885838931, lng: 46.73381020522935 },
  //1g1
  { lat: 24.610923667182416, lng: 46.72830791626227 },
  //1f9
  { lat: 24.618235290205043, lng: 46.72501443192281 },
  //1f8
  { lat: 24.62534739967297, lng: 46.72103820880468 },
  //1f7
  { lat: 24.62963131216519, lng: 46.717644743355024, 
    major:true,
    fill: "#ec7026",
    stroke: "#2db5e4" },
  //1f5
  { lat: 24.638873730770598, lng: 46.71797893662322 },
  //1f2
  { lat: 24.65605907482421, lng: 46.70833275898937 },
  //1e2
  { lat: 24.65937806638777, lng: 46.70500072886349 },
  //1d5
  { lat: 24.666755399586886, lng: 46.70160476836777 },
  //1d2
  { lat: 24.672670869251895, lng: 46.69579145306573 },
  //1c4
  { lat: 24.686965464677996, lng: 46.6886278024901 },
  //1c3
  { lat: 24.696453, lng: 46.683838 },
  //1c2
  { lat: 24.702981, lng: 46.680497 },
  //1c1
  { lat: 24.713819, lng: 46.675011 },
    //1B4
    { lat: 24.722184, lng: 46.670799 },
      //1B3
   { lat: 24.729204, lng: 46.667248 ,
    major: true,
    fill: "#d52f45",
    stroke: "#2db5e4"},
   //1B2
   { lat: 24.737317, lng: 46.663139 },
    //1B1
  { lat: 24.745389, lng: 46.659058 },
  //1A2
  { lat: 24.754516, lng: 46.654444 },
   //1Z2
  { lat: 24.811523, lng: 46.625706 },
   //1Y2
  { lat: 24.829501, lng: 46.616639 },
];

export const purpleLineCoordinates = [
  { lat: 24.701544732439746, lng: 46.82997340104743 },

  { lat: 24.702481, lng: 46.826109 },

  { lat: 24.722755, lng: 46.811123 },

  { lat: 24.737718, lng: 46.800191 },
  { lat: 24.73897, lng: 46.79988 },
  { lat: 24.742049, lng: 46.797681 },

  { lat: 24.74258, lng: 46.797606 },
  { lat: 24.745031, lng: 46.798475 },
  { lat: 24.745786, lng: 46.798373 },

  { lat: 24.756818, lng: 46.790191 },
  ...
  { lat: 24.763504, lng: 46.785273 },
  { lat: 24.764819, lng: 46.785058 },

  { lat: 24.776303, lng: 46.776466 },
  { lat: 24.786844, lng: 46.768699 },

  { lat: 24.791337, lng: 46.766339 },
  { lat: 24.79483122103988, lng: 46.76451606921388 },
  { lat: 24.799002, lng: 46.762364 },
  { lat: 24.799431, lng: 46.761742 },

  { lat: 24.799636, lng: 46.761173 },

  { lat: 24.799529, lng: 46.760207 },
  ...
  { lat: 24.785525, lng: 46.726634 },
  { lat: 24.785632, lng: 46.725894 },

  { lat: 24.786148, lng: 46.725261 },

  { lat: 24.787424, lng: 46.724607 },
  { lat: 24.788827, lng: 46.723405 },
  { lat: 24.790385, lng: 46.721072 },
  { lat: 24.791103, lng: 46.72027 },
  { lat: 24.791505, lng: 46.720037 },
  { lat: 24.792255, lng: 46.719796 },
  { lat: 24.793051, lng: 46.719828 },
  { lat: 24.794312, lng: 46.720209 },
  { lat: 24.794714, lng: 46.720268 },
  { lat: 24.795219, lng: 46.720271 },

  { lat: 24.795587, lng: 46.720264 },

  { lat: 24.796505, lng: 46.720017 },
  ...
  { lat: 24.786313371285853, lng: 46.66048734274488 },
  { lat: 24.779615, lng: 46.644446 },
  { lat: 24.778709, lng: 46.643405 },
  { lat: 24.774452, lng: 46.641495 },

  { lat: 24.773439, lng: 46.641516 },
  { lat: 24.770614, lng: 46.642836 },
...
export const purpleStations = [
  {
    lat: 24.701603197567323,
    lng: 46.82973083654435,
    major: true,
    fill: "#97187f",
    stroke: "#ec7026",
  },
  { lat: 24.72538543942224, lng: 46.80924967939298 },
  { lat: 24.74704922442019, lng: 46.797436362684806 },
  { lat: 24.756818, lng: 46.790191 },

  {
    lat: 24.77613389390801,
    lng: 46.776594299825874,
    major: true,
    fill: "#97187f",
    stroke: "#d52f45",
  },
  { lat: 24.79584942916963, lng: 46.76400041261822 },
  { lat: 24.786470592596412, lng: 46.729410215873166 },
  {
    lat: 24.807249769774963,
    lng: 46.710444116424796,
    major: true,
    fill: "#97187f",
    stroke: "#e4d60e",
  },
  {
    lat: 24.80028070373337,
    lng: 46.69380897694649,
    major: true,
    fill: "#97187f",
    stroke: "#e4d60e",
  },
  {
    lat: 24.786314782741623,
    lng: 46.66049079988645,
    major: true,
    fill: "#97187f",
    stroke: "#e4d60e",
  },
...
export const greenLineCoordinates = [
  ...
  { lat: 24.74344476146717, lng: 46.7008741643831 },
];

export const greenStations = [
  {
    lat: 24.64530273122771,
    lng: 46.71570998231822,
    major: true,
    fill: "#51a532",
    stroke: "#2db5e4",
  },
  ...
  {
    lat: 24.74344476146717,
    lng: 46.7008741643831,
    major: true,
    fill: "#51a532",
    stroke: "#d52f45",
  },
...
export const orangeLineCoordinates = [
  ...
  { lat: 24.62144, lng: 46.703403 },
  { lat: 24.624117, lng: 46.707807 },

  //stations//
  { lat: 24.628693, lng: 46.71594 },
  //stations//
  ...
  { lat: 24.6696, lng: 46.751069 },

  //stations//
  { lat: 24.673135, lng: 46.760332 },
  //stations//

  { lat: 24.67598, lng: 46.766673 },
...
//-------------------------------------------
// Red Line
export const redLineCoordinates = [
  { lat: 24.793986, lng: 46.837928 },
  //station 1
  { lat: 24.793158, lng: 46.836369 },
  //Line
  { lat: 24.792632, lng: 46.834405 },
  { lat: 24.798262, lng: 46.829473 },
  { lat: 24.800687, lng: 46.827354 },

  //Line
  { lat: 24.800055, lng: 46.823396 },
  { lat: 24.787971, lng: 46.803832 },
  //station 2
  { lat: 24.792241, lng: 46.810641 },

  //station 3
  { lat: 24.782304, lng: 46.794681 },
  //Line
  { lat: 24.779254, lng: 46.788811 },
  { lat: 24.778035, lng: 46.781763 },
  { lat: 24.777222, lng: 46.778525 },

  //station 4
  { lat: 24.776468, lng: 46.777187 },
  //Line
  { lat: 24.773001, lng: 46.771033 },

  //station 5 2D2
  { lat: 24.767621, lng: 46.759165 },
  //Line
  { lat: 24.76549, lng: 46.753311 },
  { lat: 24.76222, lng: 46.744552 },
  { lat: 24.756604, lng: 46.731334 },

  //station 6 2C3
  { lat: 24.754556, lng: 46.727036 },
  //Line
  { lat: 24.746265, lng: 46.707904 },

  //station 7 2C2
  { lat: 24.741288, lng: 46.6955 },
  //Line
  { lat: 24.738089, lng: 46.688466 },

  //station 8 2C1
  { lat: 24.73665, lng: 46.685215 },

  //station 9 2B4
  { lat: 24.733406, lng: 46.677325 },

  //Line
  { lat: 24.724046, lng: 46.65516 },
  //station 10 2B1
  { lat: 24.723727, lng: 46.653356 },

  //station 11 2A3
  { lat: 24.720519, lng: 46.646816 },
  //station 12 2A2
  { lat: 24.717057, lng: 46.638762 },
  //Line
  { lat: 24.715896, lng: 46.635784 },
  { lat: 24.715316, lng: 46.634524 },
  { lat: 24.715253, lng: 46.632703 },
  { lat: 24.714054, lng: 46.631366 },

  //station 13 2A1
  { lat: 24.710868, lng: 46.628675 },
  //Line
  { lat: 24.709748, lng: 46.627905 },
];
...
export const redStations = [
  ...
  { lat: 24.782304, lng: 46.794681 },
  //station 4
  { lat: 24.77613389390801, lng: 46.776594299825874 },
  //station 5 2D2
  { lat: 24.767621, lng: 46.759165 },
  //station 6 2C3
  { lat: 24.754556, lng: 46.727036 },
...
export const yellowLineCoordinates = [
  { lat: 24.954785624004437, lng: 46.70283601708884 },
  { lat: 24.951520633660515, lng: 46.70520176446105 },
  { lat: 24.947872621200812, lng: 46.707081938140576 },
  { lat: 24.943324609659015, lng: 46.708369852343424 },
  { lat: 24.940752786753173, lng: 46.70976576853283 },
  { lat: 24.93609358343881, lng: 46.712677386662776 },
  { lat: 24.927168814397234, lng: 46.71833582227532 },
  { lat: 24.92031065096149, lng: 46.72243885823111 },
  { lat: 24.916395003513568, lng: 46.72367245083964 },
  { lat: 24.913182069021, lng: 46.72292960490469 },
  { lat: 24.91004701307303, lng: 46.72050801788448 },
  { lat: 24.900423360595155, lng: 46.702857392535314 },
  { lat: 24.89500561425472, lng: 46.69752960269922 },
  { lat: 24.890092006434454, lng: 46.6951825087855 },
  { lat: 24.885419563743884, lng: 46.69453007738608 },
  { lat: 24.872603042258497, lng: 46.694937456748605 },
  { lat: 24.87191160998986, lng: 46.69504513089416 },
  { lat: 24.868287123898227, lng: 46.698692677451625 },
  { lat: 24.86024619267114, lng: 46.70406578219624 },
  { lat: 24.835247040529264, lng: 46.719442424737835 },
  { lat: 24.832704880980735, lng: 46.721034260214466 },
  { lat: 24.829311113862055, lng: 46.72131158416682 },
  { lat: 24.82594225472853, lng: 46.71904254989056 },
  { lat: 24.81991367909012, lng: 46.716021848241766 },
  { lat: 24.8171736381414, lng: 46.714702891470864 },
  { lat: 24.815339363534857, lng: 46.71404471291676 },
  { lat: 24.808230418537928, lng: 46.71267172286743 },
  { lat: 24.807249769774963, lng: 46.710444116424796 },
  { lat: 24.786313371285853, lng: 46.66048734274488 },
  { lat: 24.779615, lng: 46.644446 },
  { lat: 24.778709, lng: 46.643405 },
